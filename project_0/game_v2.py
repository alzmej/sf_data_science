...
def game_core(number):
    '''Функция вычисляет загаданное число как точку на отрезке, используя 
       алгоритм поиска минимума/максимума функции методом золотого сечения. 
       Функция принимает загаданное число и возвращает число попыток.
       Сначала вычисляются стартовые значения, затем пошаговое приближение 
       к загаданному числу.'''
    count = 1
    ...
    gold_point_2 = round(point_start +
                         (point_end - point_start) / golden_ratio)
